  ...
  <div
    ...
    <BaseCard>
      ...
      <div class="inline-block w-full">
        ...
        <div class="border-2 px-2 border-dotted py-2">
          <AlertComponents alert="Awesome simple alert"
    ...
    <BaseCard>
      ...
      <div class="inline-block w-full">
        ...
        <div class="border-2 px-2 border-dotted py-2">
          ...
          <AlertComponents icon="fa-solid fa-triangle-exclamation" alert="Awesome simple alert"
            :customClass="'smooth alert bg-[#ebeff4] flex gap-2 items-center text-[#64748b] p-4 rounded-xl mb-2 w-full'" />
          <AlertComponents icon="fa-solid fa-circle-exclamation" alert="Awesome simple alert"
    ...
    <BaseCard>
      ...
      <div class="inline-block w-full">
        ...
        <div class="border-2 px-2 border-dotted py-2">
          <AlertComponents alerth="Awesome alert with additional infoNew" newe="new" alertContent="Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
    ...
    <BaseCard>
      ...
      <div class="inline-block w-full">
        ...
        <div class="border-2 px-2 border-dotted py-2">
          ...
          <AlertComponents @cancelAlert="iscanceled[0] = false" v-if="iscanceled[0]"
            icon="fa-solid fa-circle-exclamation" alert="Awesome simple alevrrt"
          ...
          <AlertComponents @cancelAlert="iscanceled[1] = false" v-if="iscanceled[1]"
            icon="fa-solid fa-triangle-exclamation" alert="Awesome simple alert"
            icontwo="fa-solid fa-xmark absolute lg:right-[210px]  md:right-[210px] right-[70px]"
            :customClass="'smooth alert bg-[#ebeff4] flex gap-2 items-center text-[#64748b] p-4 rounded-xl mb-2 w-full  '" />

          <AlertComponents @cancelAlert="iscanceled[2] = false" v-if="iscanceled[2]"
            icon="fa-solid fa-circle-exclamation" alert="Awesome simple alert"
            icontwo="fa-solid fa-xmark absolute lg:right-[210px]  md:right-[210px] right-[70px]"
            :customClass="'smooth alert bg-[#0d9488] flex gap-2 items-center text-[#0f107a] p-4 rounded-xl mb-2 w-full  '" />

          <AlertComponents @cancelAlert="iscanceled[3] = false" v-if="iscanceled[3]"
            icon="fa-solid fa-triangle-exclamation" alert="Awesome simple alert"
            icontwo="fa-solid fa-xmark absolute lg:right-[210px]  md:right-[210px] right-[70px]"
            :customClass="'smooth alert border-[#247ba0] flex gap-2 items-center border-2 text-[#247ba0] p-4 rounded-xl mb-2 w-full  '" />

          <AlertComponents @cancelAlert="iscanceled[4] = false" v-if="iscanceled[4]"
            icon="fa-solid fa-circle-exclamation" alert="Awesome simple alert"
            icontwo="fa-solid fa-xmark absolute lg:right-[210px]  md:right-[210px] right-[70px]"
            :customClass="'smooth alert border-[#b91c1c] border-2 flex gap-2 items-center text-[#b91c1c] p-4 rounded-xl mb-2 w-full  '" />

          <AlertComponents @cancelAlert="iscanceled[5] = false" v-if="iscanceled[5]"
            icon="fa-solid fa-triangle-exclamation" alert="Awesome simple alert"
            icontwo="fa-solid fa-xmark absolute lg:right-[210px]  md:right-[210px] right-[70px]"
